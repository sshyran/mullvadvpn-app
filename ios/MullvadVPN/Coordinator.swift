...
public extension PresentationCoordinator {
    ...
    func dismissCoordinator(
        _ childCoordinator: _PresentationCoordinator,
        animated: Bool,
        completion: (() -> Void)? = nil
    ) {
...
// *******************************
///  Handles the navigation flow between one or more `UIViewController`s and/or `Coordinator`s,
/// pulling the responsibility of navigation one level above.
